...
const experiences = [
  ...
  },
  {
    ...
    tagActive: false,
    bullets: [
      'Owned end-to-end delivery of scalable web applications and data-backed features, from requirements and system design through production deployment, cutting average delivery time by 20%.',
      'Designed and optimized RESTful APIs, SQL and MongoDB schemas, and data access layers, reducing average query response times by 30%.',
      'Built automated data workflows in Python and Node.js to source, clean, transform, and validate data from third-party APIs, with quality checks that reduced data errors reaching production.',
      'Developed client-facing reporting modules and interactive dashboards surfacing operational KPIs.',
      'Implemented automated testing and CI/CD pipelines, reducing production bugs by 40%.',
      'Mentored interns and junior developers on best practices, code reviews, and debugging.',
    ],
    tech: ['React.js', 'Node.js', 'Express.js', 'MongoDB', 'SQL', 'Python', 'TypeScript', 'Redis', 'Docker', 'Git', 'REST APIs', 'AWS'],
  },
  {
    id:       3,
    category: 'tech',
